          ...
          {isHome && (
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <input type="submit" value="Search recipt" className=" cursor-pointer bg-orange-800 hover:bg-orange-900 text-white font-extrabold w-full p-2 rounded-lg uppercase" />
              </div>
            </form>
          )}
